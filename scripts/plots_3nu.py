...
fNO = FortEPiaNORun("OUT/3nu/20_ci_no/", label="NO")
fIO = FortEPiaNORun("OUT/3nu/20_ci_io/", label="IO")
fNOd = FortEPiaNORun("OUT/3nu/20_df_no/", label="NO damp")
fIOd = FortEPiaNORun("OUT/3nu/20_df_io/", label="IO damp")
fnoosc20 = FortEPiaNORun("OUT/3nu/20_noosc/", label="no osc Ny=20", full=False)
fNO40 = FortEPiaNORun("OUT/3nu/40_ci_no/", label="NO")
fIO40 = FortEPiaNORun("OUT/3nu/40_ci_io/", label="IO")
fNO40d = FortEPiaNORun("OUT/3nu/40_df_no/", label="NO damp")
fIO40d = FortEPiaNORun("OUT/3nu/40_df_io/", label="IO damp")
fNO40nm = FortEPiaNORun("OUT/3nu/40_df_nm/", label="NO no mix")
fNO40nd = FortEPiaNORun("OUT/3nu/40_nd_no/", label="NO no damp")
fnoosc40 = FortEPiaNORun("OUT/3nu/40_noosc/", label="no osc Ny=40", full=False)
fNO70 = FortEPiaNORun("OUT/3nu/70_ci_no/", label="NO")
fIO70 = FortEPiaNORun("OUT/3nu/70_ci_io/", label="IO")
fNO70d = FortEPiaNORun("OUT/3nu/70_df_no/", label="NO damp")
fIO70d = FortEPiaNORun("OUT/3nu/70_df_io/", label="IO damp")
fnoosc70 = FortEPiaNORun("OUT/3nu/70_noosc/", label="no osc Ny=70", full=False)
fNO100 = FortEPiaNORun("OUT/3nu/100_ci_no/", label="NO")
fIO100 = FortEPiaNORun("OUT/3nu/100_ci_io/", label="IO")
fNO100d = FortEPiaNORun("OUT/3nu/100_df_no/", label="NO damp")
fIO100d = FortEPiaNORun("OUT/3nu/100_df_io/", label="IO damp")
fnoosc100 = FortEPiaNORun("OUT/3nu/100_noosc/", label="no osc Ny=100", full=False)
