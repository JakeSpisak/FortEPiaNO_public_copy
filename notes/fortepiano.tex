...
$b_1 = -0.529157$, and $b_2 = 0.20649$ \cite{Bennett:inprep}.
...
We verified \cite{Bennett:inprep} that the results on \Neff\ are not significantly affected by the choice of $x_{\rm in}$,
...
within the code.
Following the studies performed in \cite{Bennett:inprep}, therefore,
...
More details on the precision of the code are discussed in \cite{Gariazzo:2019gyi,Bennett:inprep}.
...
$\Neff=3.0433$,
is of order $2\times10^{-4}$ \cite{Bennett:inprep}.
