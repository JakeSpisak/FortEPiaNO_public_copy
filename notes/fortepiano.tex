...
%
\item \texttt{rho\_final.dat} and \texttt{rho\_final\_mass.dat}: the final neutrino energy density,
...
the associated python utilities can be used to complete the information,
