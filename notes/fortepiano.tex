...
These two quantities affect the definitions of comoving energy density and pressure,
...
$E_p=\sqrt{p^2 + M_i^2}$ with $M_i = m_i\, a$ (the comoving mass of the particle)
and $z$ must be substituted with $w$ in the case of neutrinos.
When the electromagnetic corrections are taken into account, the photon has a comoving mass
$(M^T_\gamma)^2=\delta m_\gamma^2(x, z)$
while for the electron
$(M^T_e)^2=x^2+\delta m_e^2(x, y, z)$.
