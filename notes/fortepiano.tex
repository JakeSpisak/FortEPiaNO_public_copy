...
\frac{2}{e^{E_p/z}+1}\,.
\end{equation}
Taking into account the first orders of the expansion, and using $r=x/z$, one has \cite{...}
\begin{eqnarray}
\delta\rho(x,z)
&=&
\delta\rho^{(2)}(x,z)
...
\todo[inline]{add formulas for P corrections}
...
The finite-temperature electromagnetic corrections are also taken into account in the calculations
...
\,.
\end{equation}
We ignore the log term that depends on $y$ in the calculation of the collision integrals.
