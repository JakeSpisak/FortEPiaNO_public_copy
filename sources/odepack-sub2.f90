...
!C***FIRST EXECUTABLE STATEMENT  DNRM2
      IF (N .GT. 0) GO TO 10
         ...
         GO TO 300
!C
!   10 ASSIGN 30 TO NEXT ! ((( PABLO ))) changed to:
   10 NEXT = 30 ! ((( PABLO )))
      SUM = ZERO
      NN = N * INCX
!C
...
!C
      I = 1
!   20    GO TO NEXT,(30, 50, 70, 110) ! ((( PABLO ))) changed to:
   20    GO TO (30,50,70,110) NEXT ! ((( PABLO )))
   30 IF (ABS(DX(I)) .GT. CUTLO) GO TO 85
!      ASSIGN 50 TO NEXT ((( PABLO ))) changed to:
      NEXT = 50 ! ((( PABLO )))
      XMAX = ZERO
!C
...
!C
!      ASSIGN 70 TO NEXT ! ((( PABLO ))) changed to:
      NEXT = 70 ! ((( PABLO )))
      GO TO 105
!C
...
!C
  100 I = J
!      ASSIGN 110 TO NEXT ! ((( PABLO ))) changed to:
      NEXT = 110 ! ((( PABLO ))) 
      SUM = (SUM / DX(I)) / DX(I)
  105 XMAX = ABS(DX(I))
      GO TO 115
